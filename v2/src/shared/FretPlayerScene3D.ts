...
// Half-width of the fixed AR volume, used only in XR to cull frets/notes scrolled outside
// it (desktop's camera frustum clips naturally instead). getFretPosition() is non-linear,
// so this isn't "N frets" of radius — getFretPosition(5) ≈ 75, a ~150-unit window (~2/3 of
// the 24-fret neck), an approximate starting point pending an in-headset check.
